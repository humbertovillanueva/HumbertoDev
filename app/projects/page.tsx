...
const projects = [
  ...
  { number: "03", title: "DispatchTrack Lite", type: "FULL-STACK DELIVERY SYSTEM", summary: "A logistics application connecting a React interface, Java APIs, and an AWS serverless backend.", stack: "REACT · JAVA · AWS LAMBDA · API GATEWAY", href: "/case-studies/dispatchtrack-lite" },
